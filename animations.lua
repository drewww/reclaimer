...
spectrum.registerAnimation("SelfDestruct", function(turns)
   ...
   return spectrum.Animation(function(t, display)
      ...
      display:putFilledRect(9 - display.camera.x, 2 - display.camera.y, 10 + turnsOffset, 3, 3, prism.Color4.RED,
      ...
      for i = 0, maxOffset do
         ...
         display:put(10 + i - display.camera.x, 3 - display.camera.y, SELF_DESTRUCT_BASE + i, prism.Color4.WHITE,
            prism.Color4.RED, math.huge)
      end
      ...
      if turns > 0 then
         ...
         display:put(10 + maxOffset + 2 - display.camera.x, 3 - display.camera.y,
            REMAINING_TURNS_BASE + turnsOffset,
            prism.Color4.WHITE,
            prism.Color4.RED, math.huge)

         for i = 0, 3 do
            display:put(10 + maxOffset + 3 + i - display.camera.x, 3 - display.camera.y,
               SELF_DESTRUCT_BASE + 8 + i,
               prism.Color4.WHITE,
               prism.Color4.RED, math.huge)
         end
      else
         display:put(10 + 7 - display.camera.x, 3 - display.camera.y, SELF_DESTRUCT_BASE + 11, prism.Color4.WHITE,
            prism.Color4.RED, math.huge)
      end
