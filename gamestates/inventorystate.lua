...
function InventoryState:keypressed(key)
    -- process the key directly, so we can capture a wide range of letters
    -- in a long inventory list.
    ...
    -- THEN check if we hit a formal keybind that would trigger return
